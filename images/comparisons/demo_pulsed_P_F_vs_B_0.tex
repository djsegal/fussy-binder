\begin{tikzpicture}[]
\begin{axis}[height = {101.6mm}, ylabel = {${{P}}_{{F}}$}, title = {Demo Pulsed}, xmin = {0.0}, xmax = {20.0}, ymax = {4000.0}, ymode = {log}, xlabel = {${{B}}_{{0}}$}, {unbounded coords=jump, scaled x ticks = false, xticklabel style={rotate = 0}, xmajorgrids = true, xtick = {0.0,5.0,10.0,15.0,20.0}, xticklabels = {0,5,10,15,20}, xtick align = inside, axis lines* = left, scaled y ticks = false, yticklabel style={rotate = 0}, log basis y=10, ymajorgrids = true, ytick = {1.0,10.0,100.0,1000.0}, yticklabels = {$10^{0}$,$10^{1}$,$10^{2}$,$10^{3}$}, ytick align = inside, axis lines* = left,     xshift = 0.0mm,
    yshift = 0.0mm,
    axis background/.style={fill={rgb,1:red,1.00000000;green,1.00000000;blue,1.00000000}}
, colorbar style={title=}}, ymin = {1.0}, width = {152.4mm}]\addplot+ [color = {rgb,1:red,0.00000000;green,0.60560316;blue,0.97868012},
draw opacity=1.0,
line width=1,
solid,mark = none,
mark size = 2.0,
